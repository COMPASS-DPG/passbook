...
import FeedbackSuccess from '@/components/competency/wpcas-survey/FeedbackSuccess';
import RenderQuestion from '@/components/competency/wpcas-survey/RenderQuestion';
...
export function SurveyForm({
  ...
  return (
    ...
    >
      {/* modal when form submit successful ignore name error modal */}
      <ErrorModal
        isOpen={isOpen}
      ...
      >
        <FeedbackSuccess
          onClose={() => setIsOpen(false)}
          onGiveNextFeedback={() => setIsOpen(false)}
        />
      </ErrorModal>
